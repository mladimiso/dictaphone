proc create_ipi_design { offsetfile design_name } {
	...
	set VGA_IP_0 [ create_bd_cell -type ip -vlnv stfc:user:VGA_IP:1.0 VGA_IP_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins VGA_IP_0/CTRL]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins VGA_IP_0/CTRL_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins VGA_IP_0/CTRL_ARESETN]
	...
	set offset_file "${bd_path}/VGA_IP_v1_0_tb_include.vh"
	...
	puts $fp "`define CTRL_SLAVE_ADDRESS ${offset_hex}"

	puts $fp "`endif"
	close $fp
}

set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores stfc:user:VGA_IP:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/VGA_IP_v1_0_tb.v
